...
- **Source** – Evaluates the trustworthiness of a content’s origin.
- **Content** – Identifies linguistic and visual anomalies typical of AI-generated material.
- **Motive** – Assesses the likely intent behind the content’s creation and distribution.
...
---
![CC0](https://licensebuttons.net/p/zero/1.0/88x31.png) This project is released under the [Creative Commons Zero 1.0 Universal license (CC0)](https://creativecommons.org/publicdomain/zero/1.0/), meaning you’re free to use, remix, adapt, and build upon it without restriction.
